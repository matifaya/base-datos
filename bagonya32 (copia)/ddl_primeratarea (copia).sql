...
CREATE TABLE `alojamiento` (
  ...
  `cocina_cabaña` tinyint(1) DEFAULT NULL,
  `garage_cabaña` tinyint(1) DEFAULT NULL,
  `parilla_cabaña` tinyint(1) DEFAULT NULL,
  `restobar_complejo` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `paquete_viaje` (
  ...
  `transporte_viaje` varchar(45) DEFAULT NULL,
  `pago_id_pago` int DEFAULT NULL,
  PRIMARY KEY (`id_viaje`),
  KEY `pago_id_pago` (`pago_id_pago`),
  CONSTRAINT `paquete_viaje_ibfk_1` FOREIGN KEY (`pago_id_pago`) REFERENCES `pago` (`id_pago`) ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proveedores` (
  ...
  `direccion` varchar(45) DEFAULT NULL,
  `nombre` varchar(45) DEFAULT NULL,
  `productos_codigo` int DEFAULT NULL,
  PRIMARY KEY (`dni`),
  KEY `productos_codigo` (`productos_codigo`),
  CONSTRAINT `proveedores_ibfk_1` FOREIGN KEY (`productos_codigo`) REFERENCES `productos` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reserva` (
  ...
  `paquete_viaje_id_viaje` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `clientes_dni` (`clientes_dni`),
  KEY `paquete_viaje_id_viaje` (`paquete_viaje_id_viaje`),
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`clientes_dni`) REFERENCES `clientes` (`dni`),
  CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`paquete_viaje_id_viaje`) REFERENCES `paquete_viaje` (`id_viaje`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-04 17:34:13
