...
insert into camion values("abc123",500,"A","grande");
insert into camionero values(48680982, "Marco Sastre567", "Mauricio","ARGENTINA", 1623425154, 10000);
insert into ciudad values(1, "mar del plata");
insert into paquete values(5, "fragil", "jorge", "marco Sastre 507", 1, 48680982);
